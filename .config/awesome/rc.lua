...
colbblk = "<span color='" .. beautiful.color_brightblack .. "'>"
colbred = "<span color='" .. beautiful.color_brightred .. "'>"
colbgre = "<span color='" .. beautiful.color_brightgreen .. "'>"
colbyel = "<span color='" .. beautiful.color_brightyellow .. "'>"
colbblu = "<span color='" .. beautiful.color_brightblue .. "'>"
colbmag = "<span color='" .. beautiful.color_brightmagenta .. "'>"
colbcya = "<span color='" .. beautiful.color_brightcyan .. "'>"
colbwhi = "<span color='" .. beautiful.color_brightwhite .. "'>"
