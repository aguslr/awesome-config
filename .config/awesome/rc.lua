...
colbblk = "<span color='" .. beautiful.color_lightblack .. "'>"
colbred = "<span color='" .. beautiful.color_lightred .. "'>"
colbgre = "<span color='" .. beautiful.color_lightgreen .. "'>"
colbyel = "<span color='" .. beautiful.color_lightyellow .. "'>"
colbblu = "<span color='" .. beautiful.color_lightblue .. "'>"
colbmag = "<span color='" .. beautiful.color_lightmagenta .. "'>"
colbcya = "<span color='" .. beautiful.color_lightcyan .. "'>"
colbwhi = "<span color='" .. beautiful.color_lightwhite .. "'>"
