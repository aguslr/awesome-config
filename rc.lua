...
shifty.config.apps = {
    ...
    { match = { "Eclipse", "Gvim", "MySQL Workbench", "Python Shell", "Qtoctave", "Scilab" }, tag = "3:dev", },
    ...
    -- Floating clients
    { match = { "alsamixer", "bash", "Empathy", "htop", "ImageMagick", "keepassx", "MPlayer", "mc", "mpv", "mutt", "Nautilus", "ncmpcpp", "Pcmanfm", "ristretto", "sensors", "Sonata", "Thunar", "Transmission", "uGet", "Update Manager", "watch", "wyrd" }, float = true },
    -- client manipulation
    { match = { "" },
