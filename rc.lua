...
shifty.config.apps = {
    ...
    { match = { "Adobe Illustrator*", "avidemux.*", "Blender", "cinelerra.*", "Darktable", "Gimp", "handbrake.*", "Inkscape", "openshot", "PencilMainWindow", "pitivi", "RawTherapee.*", "UFRaw" }, tag = "5:graph", },
    ...
    -- Floating clients
    { match = { "alsamixer", "bash", "Empathy", "htop", "ImageMagick", "keepassx", "MPlayer", "mc", "mutt", "Nautilus", "ncmpcpp", "Pcmanfm", "ristretto", "sensors", "Sonata", "Thunar", "Transmission", "uGet", "watch", "wyrd" }, float = true },
    -- client manipulation
    { match = { "" },
